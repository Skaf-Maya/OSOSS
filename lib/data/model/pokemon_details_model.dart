   ...
   PokemonDetailModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json["forms"] != null) {
      ...
      json['forms'].forEach((v) {
        forms!.add(Species.fromJson(v));
      });
    }
    if (json["game_indices"] != null) {
      gameIndices = [];
      json['game_indices'].forEach((v) {
        gameIndices!.add(GameIndex.fromJson(v));
      });
    }
    height= json["height"];
    if (json["held_items"] != null) {
      ...
      json['held_items'].forEach((v) {
        heldItems!.add(HeldItem.fromJson(v));
      });
    }
    id= json["id"];
    ...
    name= json["name"];
    order= json["order"];
    pastTypes = json['past_types'] != null ? json['past_types'].cast<String>() : [];
...
class Versions {
  ...
  Versions.fromJson(Map<String, dynamic> json) {
    ...
    generationVi = Map.from(json["generation-vi"]).map((k, v) =>
        MapEntry<String, Home>(k, Home.fromJson(v)));
